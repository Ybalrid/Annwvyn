...
AnnVect3::AnnVect3(const float cx, const float cy, const float cz) :
 Vector3(cx, cy, cz) { init(); }
...
AnnVect3::AnnVect3(float* const r) :
 Vector3(r) { init(); }

AnnVect3::AnnVect3(const float s) :
 Vector3(s) { init(); }

AnnVect3::AnnVect3(const btVector3& v) :
 Vector3(v.x(), v.y(), v.z()) { init(); }
