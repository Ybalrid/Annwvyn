...
/*
 * This is the declaration a super simple "Level" class.
 * A level is the virtual environment where you'll set the user into.
 * 
 * You can have as many level as you want, and you can switch between levels at will.
 * 
 * You need to implement a constructor that initialize the level object, and at least 2 methods:
 * 
 ...
 *  The "load()" code will only be executed if the engine "switchTo" the level level. Creating GameObjects in the level constructor is undefined behavior as far as
